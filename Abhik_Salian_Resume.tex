...
\address{+91 7411328238 \\ Mangaluru, Karnataka, India \\ \href{https://abhiksalian.github.io/portfolio/}{\textcolor{black}{abhiksalian.github.io/portfolio}}}
...
\begin{rSection}{PROFILE}
    ...
    % career and contribute to innovative projects. Good grip on topics related to avionics, proficient in algorithms,
...
\begin{rSection}{INTERNSHIPS}
    \textbf{Software Engineer Intern} \hfill Feb 2025 - present\\
    Winman Software India LLP \hfill \textit{Mangaluru, Karnataka}
    \begin{itemize}
        \itemsep -3pt {}
        \item Currently working in the coding department as a Software Tester along with Research and Development.
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item This internship helped me gain hands-on experience in managing and configuring the Salesforce platform.
              % \item I was awarded with the Salesforce Administrator Certification after the completion of the internship.
    \end{itemize}
...
\begin{rSection}{Certifications}
    ...
    \begin{itemize}
        ...
        \item \textbf{Ethical Hacking Certification} \hfill Nov 2024
            ...
            Certified in Ethical Hacking by NPTEL, focusing on cybersecurity principles and ethical hacking techniques.


        \item \textbf{TechA Blockchain Developer Certification} \hfill July 2024
              \\
                Certified in TechA Blockchain Development from Infosys Springboard, demonstrating proficiency in blockchain technologies and smart contract development.
...
\begin{rSection}{PROJECTS}
    \begin{itemize}
        ...
        \item \textbf{BabySphere} is an all-in-one mobile app being built for caretakers of infants to remotely monitor their vitals, access live camera feeds, and receive alerts when the baby is sleeping in an unsafe position.
        ...
        \item \textbf{B-LOCK: A Blockchain based e-vault application}{, is an application designed to securely store and manage files using Blockchain Technology with React JS as the front-end technology.
              ...
              % \item Developed a full-stack banking web application with Django, featuring secure fund transfers, bill payments, and transaction history tracking.
...
%     \begin{itemize}
%         % \item 	\textbf{Chief Pilot Trainer} at \textbf{SJEC AERO}, which is the aeromodelling club of St. Joseph Engineering College.
...
%               % \item 	\textbf{Chief Pilot Trainer} at \textbf{SJEC AERO}, which is an aeromodelling club of St. Joseph Engineering College, established with an aim to create innovation in the field of aviation with regard to Unmanned Aerial Vehicles (RC planes and drones). SJEC AERO also takes part in various Aeromodelling competitions across India.
