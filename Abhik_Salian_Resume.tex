...
{
    As a dedicated Computer Science undergraduate with a consistent 
...
\item Worked as a freelancer on \textbf{WordPress site} for a UAE-based company that delivers POS solutions. I contributed towards the implemetation of ContactForm7 plugin integration.
