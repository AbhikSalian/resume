...
{
    As a dedicated Computer Science undergraduate and an unlicensed UAV pilot with a consistent 
...
Technical Skills & C, Java, Python, Git, HTML, CSS, JavaScript, React JS,
  Node JS, 
  MySQL, PHP
%   , SolidWorks
